...
class ifx_dig_test_filter_both extends ifx_dig_testbase;
    ...
    task main_phase(uvm_phase phase);
        ...
        foreach(filter_list[ifilt]) begin
            ...
            pin_filter_generic_seq.driving_edge_auto_select  = 1; //in sequence_lib, e definit pentru a se selecta automat tipul filtrului, altfel ar fi trebuit sa fim atenti la trecerea din 1 in 0 sau invers
            //se poate face si cu levels
